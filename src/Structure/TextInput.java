...
public class TextInput extends Button {
    ...
    public void drawButton(){
        ...
        //     textInterpreter.drawText(Game.Graphics(), contentsWithCursor(), super.x(), super.y()+fontSize, lineCharLim, 30);
        // } else {
        //     textInterpreter.drawText(Game.Graphics(),contents, super.x(), super.y()+fontSize, lineCharLim, 30);
        // }
